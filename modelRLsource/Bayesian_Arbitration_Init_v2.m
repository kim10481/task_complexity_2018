function [myArbitrator]=Bayesian_Arbitration_Init_v2(N_state,N_action,N_transition,mode)
...
if mode.ori == 2
    myArbitrator.m2_absPEestimate=zeros(3,1);
else
    myArbitrator.m2_absPEestimate=zeros(1,1);
end
...
myArbitrator.m2_inv_Fano_color=(myArbitrator.m2_mean)./myArbitrator.m2_var;
