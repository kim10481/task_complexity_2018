function [myState]=Model_RL_Init_v2(N_state,N_action,N_transition,mode)
...
if mode.ori == 2
    myState.RPE_history=zeros(N_transition,3);
else
    myState.RPE_history=zeros(N_transition,1);
end
myState.SPE_history=zeros(N_transition,1);
myState.Q=ones(N_state,N_action)*1e-10;
myState.Q_intgrtd=ones(N_state,N_action)*1e-10;
